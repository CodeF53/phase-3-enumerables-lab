...
#pp get_spicy_food_by_cuisine(spicy_foods, "American")
...
def average_heat_level(spicy_foods)
  spicy_foods.sum {|food| food[:heat_level] } / spicy_foods.length.to_f
end
